defmodule Dart.AuthTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{email: "test@test-1.com", password: "password"}
    @update_attrs %{email: "test@test-2.com", password: "password2"}
    ...
    test "create_user/1 with valid data creates a user" do
      ...
      assert user.email == "test@test-1.com"
    ...
    test "update_user/2 with valid data updates the user" do
      ...
      assert user.email == "test@test-2.com"
      assert Bcrypt.verify_pass("password2", user.password_hash)
    end
